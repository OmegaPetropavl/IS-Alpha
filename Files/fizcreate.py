...
class Ui_fizcreate(object):
    def setupUi(self, fizcreate):
        ...
        fizcreate.setFixedSize(465, 493)
...
"}")
        ...
        self.okey.clicked.connect(lambda: self.addarendator())
    ...
    def addarendator(self):
        try:
            ...
            query = "INSERT INTO `fizlitca` (`FIO`, `Passport`, `IIN`, `Adress`, `Phone`) VALUES ('" +fio + "', '" +passport + "', '" +iin1 + "', '" +adress + "', '" +phone + "')"
            mycursor.execute(query)
            db.commit()
            error = QMessageBox()
            error.setWindowTitle('Успех')
            error.setText('Арендатор успешно внесен!')
